 ...
 * @constructor
 */
declare function Pool(script?: string | undefined, options?: import("workerpool/types/types.js").WorkerPoolOptions | undefined): void;
declare class Pool {
    /**
     * A pool to manage workers, which can be created using the function workerpool.pool.
     *
     ...
     * @constructor
     */
    constructor(script?: string | undefined, options?: import("workerpool/types/types.js").WorkerPoolOptions | undefined);
    /** @readonly */
    ...
    /** @readonly */
    readonly onCreateWorker: ((arg: import("workerpool/types/types.js").WorkerArg) => import("workerpool/types/types.js").WorkerArg | undefined) | (() => null);
    /** @readonly */
    readonly onTerminateWorker: (arg: import("workerpool/types/types.js").WorkerArg) => void;
    /** @readonly */
     ...
     */
    exec<T extends (...args: any[]) => any>(method: string | T, params?: Parameters<T> | null | undefined, options?: import("workerpool/types/types.js").ExecOptions | undefined): Promise<ReturnType<T>>;
    /**
    ...
    }>(...args: any[]): Promise<import("workerpool/types/types.js").Proxy<T>, Error>;
    private _next;
    private _getWorker;
...
import { Promise } from "workerpool/types/Promise.js";
