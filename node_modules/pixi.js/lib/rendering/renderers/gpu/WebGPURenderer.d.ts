import { AbstractRenderer } from 'pixi.js/lib/rendering/renderers/shared/system/AbstractRenderer';
import { BindGroupSystem } from 'pixi.js/lib/rendering/renderers/gpu/BindGroupSystem';
import { GpuBufferSystem } from 'pixi.js/lib/rendering/renderers/gpu/buffer/GpuBufferSystem';
import { GpuColorMaskSystem } from 'pixi.js/lib/rendering/renderers/gpu/GpuColorMaskSystem';
import { type GPU, GpuDeviceSystem } from 'pixi.js/lib/rendering/renderers/gpu/GpuDeviceSystem';
import { GpuEncoderSystem } from 'pixi.js/lib/rendering/renderers/gpu/GpuEncoderSystem';
import { GpuStencilSystem } from 'pixi.js/lib/rendering/renderers/gpu/GpuStencilSystem';
import { GpuUboSystem } from 'pixi.js/lib/rendering/renderers/gpu/GpuUboSystem';
import { GpuUniformBatchPipe } from 'pixi.js/lib/rendering/renderers/gpu/GpuUniformBatchPipe';
import { PipelineSystem } from 'pixi.js/lib/rendering/renderers/gpu/pipeline/PipelineSystem';
import { GpuRenderTargetSystem } from 'pixi.js/lib/rendering/renderers/gpu/renderTarget/GpuRenderTargetSystem';
import { GpuShaderSystem } from 'pixi.js/lib/rendering/renderers/gpu/shader/GpuShaderSystem';
import { GpuStateSystem } from 'pixi.js/lib/rendering/renderers/gpu/state/GpuStateSystem';
import { GpuTextureSystem } from 'pixi.js/lib/rendering/renderers/gpu/texture/GpuTextureSystem';
...
import type { ExtractRendererOptions, ExtractSystemTypes } from 'pixi.js/lib/rendering/renderers/shared/system/utils/typeUtils';
declare const DefaultWebGPUSystems: (typeof import("pixi.js/lib/rendering").BackgroundSystem | typeof import("pixi.js/lib/rendering").GenerateTextureSystem | typeof import("pixi.js/lib/rendering").GlobalUniformSystem | typeof import("pixi.js/lib/rendering").HelloSystem | typeof import("pixi.js/lib/rendering").ViewSystem | typeof import("pixi.js/lib").RenderGroupSystem | typeof import("pixi.js/lib/rendering").TextureGCSystem | typeof import("pixi.js/lib/rendering").ExtractSystem | typeof import("pixi.js/lib").RendererInitHook | typeof import("pixi.js/lib/rendering").RenderableGCSystem | typeof import("pixi.js/lib/rendering").SchedulerSystem | typeof GpuUboSystem | typeof GpuEncoderSystem | typeof GpuDeviceSystem | typeof GpuBufferSystem | typeof GpuTextureSystem | typeof GpuRenderTargetSystem | typeof GpuShaderSystem | typeof GpuStateSystem | typeof PipelineSystem | typeof GpuColorMaskSystem | typeof GpuStencilSystem | typeof BindGroupSystem)[];
declare const DefaultWebGPUPipes: (typeof import("pixi.js/lib/rendering").BlendModePipe | typeof import("pixi.js/lib/rendering").BatcherPipe | typeof import("pixi.js/lib").SpritePipe | typeof import("pixi.js/lib").RenderGroupPipe | typeof import("pixi.js/lib/rendering").AlphaMaskPipe | typeof import("pixi.js/lib/rendering").StencilMaskPipe | typeof import("pixi.js/lib/rendering").ColorMaskPipe | typeof import("pixi.js/lib").CustomRenderPipe | typeof GpuUniformBatchPipe)[];
