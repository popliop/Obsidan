...
import { GlRenderTarget } from 'pixi.js/lib/rendering/renderers/gl/GlRenderTarget';
...
import type { RenderTargetAdaptor, RenderTargetSystem } from 'pixi.js/lib/rendering/renderers/shared/renderTarget/RenderTargetSystem';
...
export declare class GlRenderTargetAdaptor implements RenderTargetAdaptor<GlRenderTarget> {
    ...
    copyToTexture(sourceRenderSurfaceTexture: RenderTarget, destinationTexture: Texture, originSrc: {
        ...
        x: number;
        y: number;
    }): Texture<import("pixi.js/lib/rendering").TextureSource<any>>;
