...
import { GlBufferSystem } from 'pixi.js/lib/rendering/renderers/gl/buffer/GlBufferSystem';
import { GlContextSystem } from 'pixi.js/lib/rendering/renderers/gl/context/GlContextSystem';
import { GlGeometrySystem } from 'pixi.js/lib/rendering/renderers/gl/geometry/GlGeometrySystem';
import { GlBackBufferSystem } from 'pixi.js/lib/rendering/renderers/gl/GlBackBufferSystem';
import { GlColorMaskSystem } from 'pixi.js/lib/rendering/renderers/gl/GlColorMaskSystem';
import { GlEncoderSystem } from 'pixi.js/lib/rendering/renderers/gl/GlEncoderSystem';
import { GlStencilSystem } from 'pixi.js/lib/rendering/renderers/gl/GlStencilSystem';
import { GlUboSystem } from 'pixi.js/lib/rendering/renderers/gl/GlUboSystem';
import { GlRenderTargetSystem } from 'pixi.js/lib/rendering/renderers/gl/renderTarget/GlRenderTargetSystem';
import { GlShaderSystem } from 'pixi.js/lib/rendering/renderers/gl/shader/GlShaderSystem';
import { GlUniformGroupSystem } from 'pixi.js/lib/rendering/renderers/gl/shader/GlUniformGroupSystem';
import { GlStateSystem } from 'pixi.js/lib/rendering/renderers/gl/state/GlStateSystem';
import { GlTextureSystem } from 'pixi.js/lib/rendering/renderers/gl/texture/GlTextureSystem';
...
declare const DefaultWebGLSystems: (typeof import("pixi.js/lib/rendering").BackgroundSystem | typeof import("pixi.js/lib/rendering").GenerateTextureSystem | typeof import("pixi.js/lib/rendering").GlobalUniformSystem | typeof import("pixi.js/lib/rendering").HelloSystem | typeof import("pixi.js/lib/rendering").ViewSystem | typeof import("pixi.js/lib").RenderGroupSystem | typeof import("pixi.js/lib/rendering").TextureGCSystem | typeof import("pixi.js/lib/rendering").ExtractSystem | typeof import("pixi.js/lib").RendererInitHook | typeof import("pixi.js/lib/rendering").RenderableGCSystem | typeof import("pixi.js/lib/rendering").SchedulerSystem | typeof GlUboSystem | typeof GlBackBufferSystem | typeof GlContextSystem | typeof GlBufferSystem | typeof GlTextureSystem | typeof GlRenderTargetSystem | typeof GlGeometrySystem | typeof GlUniformGroupSystem | typeof GlShaderSystem | typeof GlEncoderSystem | typeof GlStateSystem | typeof GlStencilSystem | typeof GlColorMaskSystem)[];
declare const DefaultWebGLPipes: (typeof import("pixi.js/lib/rendering").BlendModePipe | typeof import("pixi.js/lib/rendering").BatcherPipe | typeof import("pixi.js/lib").SpritePipe | typeof import("pixi.js/lib").RenderGroupPipe | typeof import("pixi.js/lib/rendering").AlphaMaskPipe | typeof import("pixi.js/lib/rendering").StencilMaskPipe | typeof import("pixi.js/lib/rendering").ColorMaskPipe | typeof import("pixi.js/lib").CustomRenderPipe)[];
