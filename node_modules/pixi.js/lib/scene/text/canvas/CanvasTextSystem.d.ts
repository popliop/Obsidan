...
export declare class CanvasTextSystem implements System {
    ...
    createTextureAndCanvas(options: {
        ...
        texture: Texture<import("pixi.js/lib").TextureSource<any>>;
        canvasAndContext: import("pixi.js/lib/rendering/renderers/shared/texture/CanvasPool").CanvasAndContext;
    };
    getManagedTexture(text: Text): Texture<import("pixi.js/lib").TextureSource<any>>;
