...
export type CiteItem = import('rehype-citation/dist/node/src/types').CiteItem;
export type Mode = import('rehype-citation/dist/node/src/types').Mode;
export type Options = import('rehype-citation/dist/node/src/types').Options;
/**
